...
export const IdentifierEntry = {
  encode(message: IdentifierEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): IdentifierEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LanguageTypedString = {
  encode(message: LanguageTypedString, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LanguageTypedString {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PersonName = {
  encode(message: PersonName, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PersonName {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PersonNameEntry = {
  encode(message: PersonNameEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nameType !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PersonNameEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OptionallyTypedEmail = {
  encode(message: OptionallyTypedEmail, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OptionallyTypedEmail {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TypedEmail = {
  encode(message: TypedEmail, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.emailType !== "") {
      writer.uint32(10).string(message.emailType);
    }
    if (message.email !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TypedEmail {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OptionallyTypedPhone = {
  encode(message: OptionallyTypedPhone, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OptionallyTypedPhone {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TypedPhone = {
  encode(message: TypedPhone, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.phoneType !== "") {
      writer.uint32(10).string(message.phoneType);
    }
    if (message.phone !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TypedPhone {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GeoCoordinates = {
  encode(message: GeoCoordinates, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GeoCoordinates {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OptionallyTypedAddress = {
  encode(message: OptionallyTypedAddress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.geo !== undefined) {
      GeoCoordinates.encode(message.geo, writer.uint32(74).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): OptionallyTypedAddress {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TypedAddress = {
  encode(message: TypedAddress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.addressType !== "") {
      writer.uint32(10).string(message.addressType);
    }
    if (message.addressCountry !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TypedAddress {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Agents = {
  encode(message: Agents, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.description) {
      LanguageTypedString.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    if (message.domain !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Agents {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Person = {
  encode(message: Person, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.primaryEmail !== undefined) {
      OptionallyTypedEmail.encode(message.primaryEmail, writer.uint32(122).fork()).ldelim();
    }
    for (const v of message.otherEmails) {
      TypedEmail.encode(v!, writer.uint32(130).fork()).ldelim();
    }
    if (message.primaryPhone !== undefined) {
      OptionallyTypedPhone.encode(message.primaryPhone, writer.uint32(138).fork()).ldelim();
    }
    for (const v of message.otherPhones) {
      TypedPhone.encode(v!, writer.uint32(146).fork()).ldelim();
    }
    if (message.primaryAddress !== undefined) {
      OptionallyTypedAddress.encode(message.primaryAddress, writer.uint32(154).fork()).ldelim();
    }
    for (const v of message.otherAddresses) {
      TypedAddress.encode(v!, writer.uint32(162).fork()).ldelim();
    }
    for (const v of message.agents) {
      Agents.encode(v!, writer.uint32(170).fork()).ldelim();
    }
  ...
  fromJSON(object: any): Person {
    return {
      ...
      otherAddresses: globalThis.Array.isArray(object?.otherAddresses)
        ...
        : [],
      agents: globalThis.Array.isArray(object?.agents) ? object.agents.map((e: any) => Agents.fromJSON(e)) : [],
...
export const Course = {
  encode(message: Course, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.title) {
      LanguageTypedString.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    for (const v of message.description) {
      LanguageTypedString.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    if (message.primaryCode !== undefined) {
      IdentifierEntry.encode(message.primaryCode, writer.uint32(58).fork()).ldelim();
    }
    for (const v of message.otherCodes) {
      IdentifierEntry.encode(v!, writer.uint32(66).fork()).ldelim();
    }
    ...
    if (message.gradingScheme !== undefined) {
      LanguageTypedString.encode(message.gradingScheme, writer.uint32(114).fork()).ldelim();
    }
...
export const SyncEvent = {
  encode(message: SyncEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.person !== undefined) {
      Person.encode(message.person, writer.uint32(10).fork()).ldelim();
    }
    if (message.course !== undefined) {
      Course.encode(message.course, writer.uint32(18).fork()).ldelim();
    }
    if (message.reset !== undefined) {
      SyncReset.encode(message.reset, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
...
export const SyncReset = {
  encode(message: SyncReset, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.reason !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SyncReset {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SISSyncService = {
  ...
  syncCourses: {
    ...
    requestSerialize: (value: SyncRequest) => Buffer.from(SyncRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SyncRequest.decode(value),
    responseSerialize: (value: Course) => Buffer.from(Course.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Course.decode(value),
  },
} as const;

export interface SISSyncServer extends UntypedServiceImplementation {
  /** Streams all persons, then pushes updates as they occur */
  syncPersons: handleServerStreamingCall<SyncRequest, Person>;
  /** Streams all courses, then pushes updates as they occur */
  syncCourses: handleServerStreamingCall<SyncRequest, Course>;
}

export interface SISSyncClient extends Client {
  /** Streams all persons, then pushes updates as they occur */
  syncPersons(request: SyncRequest, options?: Partial<CallOptions>): ClientReadableStream<Person>;
  syncPersons(request: SyncRequest, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<Person>;
  /** Streams all courses, then pushes updates as they occur */
  syncCourses(request: SyncRequest, options?: Partial<CallOptions>): ClientReadableStream<Course>;
  syncCourses(request: SyncRequest, metadata?: Metadata, options?: Partial<CallOptions>): ClientReadableStream<Course>;
}
